...
/>
  ...
  {selectedCard.forms && selectedCard.forms.length > 1 && (
    <button
      ...
      className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full border border-[#E0FF4F] bg-black/60 px-3 py-2 text-[#E0FF4F] hover:bg-[#E0FF4F] hover:text-black transition"
    >
      ›
    </button>
  )}
        ...
        />
            ...
            <div className="flex flex-col gap-4 h-full overflow-y-auto pr-2">
              ...
              <div className="bg-[#18181B]/70 rounded-xl p-3 border border-[#27272A] flex items-center gap-4">
                ...
                {(activeForm.weapon ?? selectedCard.weapon) && (
  <img
    src={weaponIcons[activeForm.weapon ?? selectedCard.weapon]}
    alt={activeForm.weapon ?? selectedCard.weapon}
    className="w-5 h-5"
  />
)}
